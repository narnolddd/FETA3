...
file = "tutorial_scripts/ArtificialTS.dat"

# Network density
set output "tutorial_scripts/plots/artificial_dense.eps"
set yrange [0:0.2]
set title 'Density'
...
# Maximum degree
set output "tutorial_scripts/plots/artificial_maxdeg.eps"
set yrange [0:40]
...
# Clustering coeff
set output "tutorial_scripts/plots/artificial_cluster.eps"
set yrange [0:0.5]
...
# Mean squared degree
set output "tutorial_scripts/plots/artificial_meandegsq.eps"
set yrange [0:100]
...
set output "tutorial_scripts/plots/artificial_assort.eps"
set yrange [-0.5:0.5]
...
# Average degree
set output "tutorial_scripts/plots/artificial_avgdeg.eps"
set yrange [0:8]
