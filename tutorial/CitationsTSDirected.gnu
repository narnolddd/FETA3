...
set output "tutorial/plots/cit_maxdeg_in.eps"
set yrange [0:200]
set title 'Maximum in-degree'
set ylabel 'kmax'
plot file using 1:6 with lines lw 3

set output "tutorial/plots/cit_maxdeg_out.eps"
set yrange [0:200]
...
set output "tutorial/plots/cit_meandegsq_in.eps"
set yrange [0:330]
set title 'Mean squared in-degree'
set ylabel '<k_in^2>'
plot file using 1:8 with lines lw 3

set output "tutorial/plots/cit_meandegsq_out.eps"
set yrange [0:330]
...
set output "tutorial/plots/cit_avgdeg_inout.eps"
set yrange [0:12]
